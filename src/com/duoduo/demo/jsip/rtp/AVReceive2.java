...
public class AVReceive2 implements ReceiveStreamListener, SessionListener, ControllerListener {
	...
	protected boolean initialize() {
		...
		try {
			synchronized (dataSync) {
				// һֱ�ȵ���һ��Participant���룬�ṩһ�����õ�StreamΪֹ
	...
	public synchronized void update(ReceiveStreamEvent evt) {
		// �Ӵ�С���ж�λ��RTPManager->Participant->ReceiveStream
		...
		if (evt instanceof RemotePayloadChangeEvent) {
			...
			try {
				...
				// ����initialize()�е�synchronized (dataSync)
				synchronized (dataSync) {
					dataReceived = true;
					dataSync.notifyAll();
				}
	...
	/**
	 * A utility class to parse the session addresses. ���û�����Ľ��зֽ� <SESSION>: <ADDRESS>/<PORT>/<TTL>
	 */
	class SessionLabel {
